        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-300 max-w-md">
              Experience cinema like never before. Stream in stunning 4K HDR with spatial audio.
            </p>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 md:p-8 bg-dark-900 min-h-screen lg:min-h-0">
        <div className="w-full max-w-md space-y-6 sm:space-y-8">
          ...
          <div className="space-y-2 text-center lg:text-left">
            ...
            <p className="text-sm sm:text-base text-gray-400">Log in to access your premium account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs sm:text-sm text-primary-400 hover:text-primary-300 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 bg-dark-800 border-dark-600 rounded text-primary-600 focus:ring-primary-500 focus:ring-offset-dark-900"
              />
